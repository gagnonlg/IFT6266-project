...
network.train_GAN(
    ...
    G_savepath='model_11.generator.best.h5',
    D_savepath='model_11.discriminator.best.h5'
)

gnetw.save('model_11.generator.final.h5')
dnetw.save('model_11.discriminator.final.h5')
