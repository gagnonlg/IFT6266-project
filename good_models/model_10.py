...
gnetw.add(network.LinearTransformation((n_in + n_z, 1000), l1=0.001))
gnetw.add(network.ReLU())
gnetw.add(network.BatchNorm(1000))
gnetw.add(network.LinearTransformation((1000, 1000), l1=0.001))
gnetw.add(network.ReLU())
gnetw.add(network.BatchNorm(1000))
gnetw.add(network.LinearTransformation((1000, 1000), l1=0.001))
gnetw.add(network.ReLU())
...
gnetw.add(network.ReLU())
gnetw.add(network.BatchNorm(1000))
gnetw.add(network.LinearTransformation((1000, n_out), l1=0.001))
...
dnetw.add(network.LinearTransformation((n_in + n_out, 1000), l1=0.001))
dnetw.add(network.ReLU())
dnetw.add(network.BatchNorm(1000))
dnetw.add(network.LinearTransformation((1000, 1000), l1=0.001))
dnetw.add(network.ReLU())
dnetw.add(network.BatchNorm(1000))
dnetw.add(network.LinearTransformation((1000, 1000), l1=0.001))
dnetw.add(network.ReLU())
...
dnetw.add(network.ReLU())
dnetw.add(network.BatchNorm(1000))
dnetw.add(network.LinearTransformation((1000, 1), l1=0.001))
...
network.train_GAN(
    ...
    G_savepath='model_10.generator.best.h5',
    D_savepath='model_10.discriminator.best.h5'
)

gnetw.save('model_10.generator.final.h5')
dnetw.save('model_10.discriminator.final.h5')
