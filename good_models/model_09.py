...
network.train_GAN(
    ...
    G_savepath='model_09.generator.best.h5',
    D_savepath='model_09.discriminator.best.h5'
)

gnetw.save('model_09.generator.final.h5')
dnetw.save('model_09.discriminator.final.h5')
