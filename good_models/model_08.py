...
network.train_GAN(
    ...
    G_savepath='model_08.generator.best.h5',
    D_savepath='model_08.discriminator.best.h5'
)

gnetw.save('model_08.generator.final.h5')
dnetw.save('model_08.discriminator.final.h5')
