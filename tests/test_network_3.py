...
mlp.add(network.LinearTransformation((1, 500), l1=0.0001))
mlp.add(network.ReLU())
mlp.add(network.LinearTransformation((500, 1), l1=0.0001))
mlp.compile(lr=0.01, momentum=0.5, batch_size=128, cache_size=(1000,1,1))
...
mlp = network.Network.load('test_model_3.h5')
